...
echo ""
echo "== Syncing bundled skills into Hermes home"

HERMES_HOME_DIR="${HERMES_HOME:-/home/hermeswebui/.hermes}"

mkdir -p "$HERMES_HOME_DIR/skills/productivity"

if [ -d "/app/skills/productivity/microsoft-365" ]; then
  rsync -av /app/skills/productivity/microsoft-365 \
           "$HERMES_HOME_DIR/skills/productivity/"
  echo "-- Microsoft 365 skill synced"
else
  echo "!! WARNING: microsoft-365 skill not found in /app"
fi
